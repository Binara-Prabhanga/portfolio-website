    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
          ...
          >
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-bold mb-6 creative-text">
              CREATIVE
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground mb-8">
              Software Engineer & Technical Writer | 4+ years full-stack, DevOps, and research experience
            </p>
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-12 text-foreground/80">
              SOFTWARE ENGINEER
            </h2>
            <p>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              ...
              and a love for creating innovative web applications. With
              expertise in modern technologies and a creative approach to
